            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Case</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="total_case_count">0</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">City Case Overview</h6>
                   ...
                   <!-- Content Row for Table -->
                    <div class="row px-2">
                         <!-- DataTales Example -->
                        <div class="card container-fluid shadow mb-4">
